...
object Deps {
  ...
  def coursierInterface = "io.get-coursier" % "interface" % "1.0.3"
  def coursierLauncher = "io.get-coursier" %% "coursier-launcher" % "2.0.12"
  ...
  def svm = "org.graalvm.nativeimage" % "svm" % "19.3.5"
  def utest = setting {
