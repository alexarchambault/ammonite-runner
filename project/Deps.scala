...
object Deps {
  ...
  def caseApp = "com.github.alexarchambault" %% "case-app" % "2.0.2"
  def coursierInterface = "io.get-coursier" % "interface" % "0.0.23"
  def coursierLauncher = "io.get-coursier" %% "coursier-launcher" % "2.0.0-RC6-22"
